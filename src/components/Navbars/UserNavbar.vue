<template>
  <!-- Navbar -->
  <nav
    class="z-10 top-0 left-0 fixed md:top-16 w-full bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4 bg-mainTheme">
      ...
      <form class="w-8/12 flex flex-row flex-wrap items-center mr-3 md:mb-0">
        <div class="relative flex w-full flex-wrap items-stretch">
          ...
          <input type="text" placeholder="Search post..."
            class="rounded-full border-0 px-3 py-3 placeholder-blueGray-600  text-blueGray-600 relative bg-second text-sm shadow outline-none focus:outline-none focus:ring w-full pl-10" />
        </div>
