                        ...
                        <div class="rounded-t mb-0 px-6 py-6 flex flex-row">
                            <div class="text-left mb-3">
                                ...
                                <h3 class="text-mainText text-base font-normal mt-3 max-w-3xl leading-relaxed break-words">
                                    Please ensure that all profile fields are correctly filled out before submitting. 
                                    Accurate profile information is essential for personalized services and seamless communication. 
                                    Failure to update your profile will prevent you from accessing other functions of the website.</h3>
