<template>
    <div class="border border-gray-300 mb-4 rounded-lg">
        ...
        <div class="flex p-4 space-x-4">
            <div
                class="w-40 flex items-center bg-secondaryMain border-3 text-mainText font-bold uppercase text-sm px-4 py-2 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                <img :src="vaccine" alt="vaccine" class="w-8 h-8 p-1" />Vaccinated
            </div>

            <div
                class="w-40 flex items-center border-mainTheme border-3 bg-secondaryMain text-mainText font-bold uppercase text-sm px-4 py-2 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                        ...
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <select id="occupation"
                                    ...
                                    <option value="artsDesignEntertainmentSportsAndMedia">Arts, Design, Entertainment,
                                    ...
                                    <option value="transportationAndMaterialMoving">Transportation and Material Moving
                                    </option>
                                    <option value="other">Other</option>
                                </select>
                            </div>
