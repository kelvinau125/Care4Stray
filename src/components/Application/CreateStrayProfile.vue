...
import { createAdoption } from "@/service/apiProviderAdoption";
...
export default {
  ...
  methods: {
    ...
    async submitApplication() {
      ...
      for (let i = 0; i < this.stray.image.length; i++) {
        const file = this.stray.image[i];
        try {
